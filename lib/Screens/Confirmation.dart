...
class Confirmation extends HookConsumerWidget {
  ...
  String ref;
  Transaction trans;
  Confirmation({super.key, required this.staff, required this.ref, required this.trans});
...
final xpayload = base64ToHex(encryption(body, auth.aesKey ?? '', auth.iv ?? ''));
  ...
  if(result.statusCode == 200) {
    ...
    var xData = decryption(base64.encode(hex.decode(jsonDecode(data))), auth.aesKey ?? '', auth.iv ?? '')[0];
  ...
  if(result.statusCode == 200) {
    ...
    var body = jsonEncode({
      ...
      "xTrans": {
        "xTransRef": ref,
        "xTransScope": operation == 'authorize' ? "246646upkjhfkwhjfj77" : operation == 'decline' ? "246646upkjhfkwhjfj77" : "",
        "xAppTransScope": operation == 'authorize' ? "2efefept9e000001" : operation == 'decline' ? "00000009e0000000" : "",
        "xAppSource": "AS-IN-D659B-e3M"
      }
    });
      ...
      child: Column(children: [
        Container(
                ...
                child: Column(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Transaction Type', style: TextStyle(),), Text(leave.value?["LeaveName"], style: const TextStyle(),)],),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Initiated By', style: TextStyle(),), Text(trans.fullName.toString(), style: const TextStyle(),)],),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Description', style: TextStyle(),), Text(trans.titleDesc.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Originating Bu', style: TextStyle(),), Text(trans.buName.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Time Stamp', style: TextStyle(),), Text(trans.timeStamp.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Approval Stage', style: TextStyle(),), Text(trans.xStageNo.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Stage Status', style: TextStyle(),), Text(trans.xStageStatus.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Record State', style: TextStyle(),), Text(trans.xRecordState.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Transaction Status', style: TextStyle(),), Text(trans.xTransStatus.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Assigned To', style: TextStyle(),), Text(trans.xAssignTo.toString(), style: const TextStyle(),)],),
                     Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [const Text('Reviewed By', style: TextStyle(),), Text(trans.tReviewer.toString(), style: const TextStyle(),)],)
                ]),
              ),
